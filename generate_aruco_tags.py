...
python generate_aruco_tags.py --id 13 --type DICT_5X5_100 -o tags/
python generate_aruco_tags.py --id 71 --type DICT_5X5_100 -o tags/
python generate_aruco_tags.py --id 16 --type DICT_7X7_1000 -o tags/
'''
...
cv2.imwrite('DICT_7X7_1000_id_16.png', tag)
